...
import pytest
from source_freshchat.source import FreshchatStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(FreshchatStream, "path", "v0/example_endpoint")
    mocker.patch.object(FreshchatStream, "primary_key", "test_primary_key")
    mocker.patch.object(FreshchatStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = FreshchatStream()
